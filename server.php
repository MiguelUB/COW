...
<body>
  <header>
    <nav class="navbar navbar-expand-lg bg-body-tertiary bg-primary mb-2"
      style="background-color: var(--color-secondary-2) !important;">
    ...
    <div class="shadow-1 p-2">
      ...
      <form>
        ...
        <button type="submit" class="btn   btn-block mb-4"
          style="background-color: var(--color-secondary-2) !important;">Ask information</button>
      </form>
    </div>
  </main>
